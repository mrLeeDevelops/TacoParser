...
namespace LoggingKata
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            if (lines.Length == 1)
            {
                logger.LogWarning("WARNING: File only has one line of input!");
            }
            ...
            // DONE--TODO: Create two `ITrackable` variables with initial values of `null`. These will be used to store your two taco bells that are the
            // farthest from each other.
            ITrackable tacoTrackable = null;
            ITrackable tacoTrackable2 = null;
